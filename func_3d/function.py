...
# torch.backends.cudnn.benchmark = True  # 注释掉：与train_3d.py中的deterministic=True设置冲突
...
def train_sam(args, net: nn.Module, optimizer1, optimizer2, train_loader,
    ...
    lossfunc = paper_loss  # 使用Dice+Focal组合，更适合3D体素分割的类不均衡与薄壁结构
    # lossfunc = criterion_G  # BCE过"软"，难以压边界指标
...
def validation_sam(args, val_loader, epoch, net: nn.Module, clean_dir=True):
    ...
    lossfunc = paper_loss  # 与训练保持一致，使用Dice+Focal组合
