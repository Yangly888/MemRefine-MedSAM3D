...
def parse_args():    
    ...
    parser.add_argument('--use_lgff', type=int, default=0, help='Whether to use LGFF module (0: disable, 1: enable)')

    # cfg.py 增量
    parser.add_argument('-cpgf', type=int, default=1, help='enable Cross-Plane Guided Fusion')
    parser.add_argument('-cpgf_heads', type=int, default=4)
    parser.add_argument('-cpgf_dim', type=int, default=32)
    parser.add_argument('-cpgf_topk', type=int, default=3, help='top-K memory feats for fusion')
    parser.add_argument('-cpgf_alpha_cap', type=float, default=0.4, help='max gate for injection')
