""" Dataloader for the FLARE dataset
"""
import os
import numpy as np
import torch
...
class FLARE(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Convert img0001 to label0001 for mask path
        mask_name = name.replace('img', 'label')
        mask_path = os.path.join(self.data_path, self.mode, 'mask', mask_name)
